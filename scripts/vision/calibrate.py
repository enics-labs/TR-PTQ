...
from ptq_tr.workflows.calibration.run import run_calibration
from ptq_tr.workflows.calibration.run import prepare_calibration_artifacts
from ptq_tr.workflows.vision import VISION_MODEL_REGISTRY, VISION_Q_MODULE_REGISTRY, build_vision_runtime


def parse_args():
    parser = argparse.ArgumentParser(description="Run vision model calibration.")
